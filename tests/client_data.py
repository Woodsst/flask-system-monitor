...
class WSRequestsForServerMonitoring:
    ...
    WELCOME = json.dumps({"type": "WELCOME", "payload": {"welcome": "WELCOME"}})


class WSRequstsForClientSystemMonitoring:
    CLIENT_DATA = json.dumps(
        {"type": "CLIENT_DATA", "data":
            data, "interval": 1, "client_id": client_id}, indent=4
         )
    EMPTY_CLIENT_DATA = json.dumps(
        {"type": "CLIENT_DATA", "data":
            {}, "interval": 1, "client_id": client_id}, indent=4
         )
